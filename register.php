...
body {
    width: 100%;
    min-height: 100vh;
    background-image: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), url(123662204-3d-render-cafe-restaurant.jpg);
...
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<p class="login-register-text">Have an account? <a href="akanksha.php">Login Here</a>.</p>
		</form>
	</div>
</body>
<script type="text/javascript">
    document.getElementByClass("login-register-text").onclick = function () {
        location.href = "akanksha.php";
    };
</script>
</html>